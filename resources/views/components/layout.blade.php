      ...
      <nav class="bg-gray-800">
              ...
              <div class="ml-4 flex items-center md:ml-6">
                ...
                @auth
                  <form action="/logout" method="POST">
                    @csrf
                    <x-form-submit>Log Out</x-form-submit>
                  </form>
                @endauth
        ...
        <div class="md:hidden" id="mobile-menu">
          <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <a href="/contact" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Conact</a>
          </div>
